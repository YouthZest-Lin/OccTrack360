...
class InfiniteGroupEachSampleInBatchSampler(Sampler):
    ...
    def __init__(self, 
        ...
        #print(f'g_nums in train:{self.groups_num}')
        #print(f'bs in train:{self.global_batch_size}')
...
class InfiniteGroupEachSampleInBatchSamplerEval(Sampler):
    ...
    def __init__(self, 
        ...
        self.groups_num = len(self.group_sizes)
        self.global_batch_size = batch_size * world_size
        #print(f'g_nums in val:{self.groups_num}')
        #print(f'bs in val:{self.global_batch_size}')
        #assert self.groups_num >= self.global_batch_size #warning: the assertation should be activate but I disable it when training
    ...
    def __iter__(self):
        ...
        t = (len(self.flag)+self.world_size*16 + 1 - 1)//self.world_size#?YzL
        for i in range(t):
