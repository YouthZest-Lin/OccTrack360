...
class OccEncoder_ori(TransformerLayerSequence):
    ...
    def __init__(self, *args, pc_range=None, grid_config=None, data_config=None,
        ...
        super(OccEncoder_ori, self).__init__(*args, **kwargs)
...
class OccFormerLayer_ori(MyCustomBaseTransformerLayer):
    ...
    def __init__(self,
                 ...
                 ffn_num_fcs=2,
                 **kwargs):
        super(OccFormerLayer_ori, self).__init__(
            attn_cfgs=attn_cfgs,
