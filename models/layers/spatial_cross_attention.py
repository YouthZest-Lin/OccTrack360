    ...
    def forward(self,
        ...
        for j in range(bs):
            for i, reference_points_per_img in enumerate(reference_points_cam):   
                ...
                #print("query[j].shape:", query[j].shape)
                #print("index_query_per_img:", index_query_per_img)
                #print("max index:", index_query_per_img.max().item())
                #print("min index:", index_query_per_img.min().item())
...
class MSDeformableAttention3D(BaseModule):
    ...
    def forward(self,
        ...
        '''
        print("spatial_shapes:", spatial_shapes.cpu())
        print("num_value:", num_value.cpu())
        print("value.shape:", value.shape.cpu())
        '''
